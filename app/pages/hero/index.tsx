            ...
            <div className="relative z-10 flex flex-col w-full gap-6">
                ...
                <div className="w-full flex justify-center flex-wrap " >
                    ...
                    <div className="flex flex-wrap lg:flex-nowrap">
                        ...
                        <div className="text-white p-10 mt-10 text-xl lg:hidden backdrop-blur-lg mask-x-from-95% mask-x-to-100% mask-y-from-95% mask-y-to-100%">{hero.lore}</div>
                    ...
                    <div className="flex flex-col justify-center w-full lg:w-1/2">
                        ...
                        <div className="flex flex-col gap-2 ">
                            {hero.hero_stories.map((hero_story, index) => (
                                <HeroStoryButton key={index} storyText={hero_story.text} storyTitle={hero_story.title} storyImage={hero_story.image.url} />
                            ))}
                        </div>
                    </div>
                </div>
